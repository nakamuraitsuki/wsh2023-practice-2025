...
CMD ["dumb-init", "./node_modules/.bin/ts-node", "-r", "ts-node/register", "./node_modules/typeorm/cli.js", "migration:run", "--dataSource", "src/server/data_source.ts", "&&", "./node_modules/.bin/ts-node", "./src/server/index.ts"]
